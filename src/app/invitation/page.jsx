...
const page = () => {
  return (
    <div className="w-full flex flex-col   md:flex-row gap-10  pt-30 p-5 items-start bg-green-100">
      <div className="md:w-[70%] rounded-xl h-full min-h-screen bg-white p-10 shadow-2xl">
        <h1 className="text-xl  md:text-5xl font-bold text-green-900">
        ...
        <div className="flex flex-col-reverse md:flex-row  gap-10 items-start mt-10 md:mt-20">
          <div className="space-y-5">
            <h2 className="text-xl md:text-3xl  text-green-700 font-bold">
            ...
            <div className="flex gap-2">
              ...
              <p className="text-md md:text-xl text-justify text-gray-700 w-fit">
          ...
          <img src="/food.png" alt="" className="md:w-[250px] rounded-xl" />
        </div>

        <div className="space-y-5 mt-15">
          <h2 className="text-xl md:text-3xl text-green-700 font-bold">Details</h2>
          ...
          <div className="flex gap-2">
            ...
            <p className="text-md md:text-xl text-gray-700 w-fit">
          ...
          <p className="text-md text-justify md:text-xl text-gray-700">
          ...
          <div>
            <p className="text-md md:text-xl text-gray-700">Warm regards.</p>
            <p className="font-display text-xl md:text-2xl text-green-800 font-semibold">
              Sudheer &amp; Prachi
            </p>
            <p className="text-md md:text-xl text-gray-700">Tathastu Wellnessess</p>
          </div>
        </div>
      </div>
      <div className="md:w-[30%]  bg-green-200 pb-10 rounded-xl px-5">
