...
const HeroSection = () => {
  return (
    <section className="flex px-4 flex-col sm:justify-center max-md:gap-20 md:flex-row pt-30 sm:pt-40 sm:px-4 md:px-16 lg:px-24 xl:px-32    w-full h-[70vh] sm:h-[80vh] bg-[url('/hero-wellness.jpg')] bg-cover bg-center bg-no-repeat">
      <div className="flex flex-col sm:items-center space-y-4  sm:space-y-6">
        ...
        <div className="flex items-center gap-4  ">
          ...
          <button className="border text-[.9rem] border-green-800 cursor-pointer text-green-800 hover:bg-green-800 hover:text-white duration-300  sm:text-sm p-2  sm:px-5 sm:py-3 rounded">
            Explore Services
          </button>
        </div>
      </div>
