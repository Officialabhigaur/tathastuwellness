export default function CallToAction() {
  return (
    <div className="flex  flex-col items-center justify-center max-w-8xl w-full mx-2 rounded-2xl space-y-4 sm:space-y-5 shadow-md bg-[#d6e2bd]  px-4 py-10 sm:py-20 text-center">
      <h1 className="text-xl  md:text-6xl font-bold text-green-900 ">
        Begin Your Journey With Us
      </h1>
      <p className="text-black text-base max-w-2xl">
