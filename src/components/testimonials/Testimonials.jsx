 const Testimonials = () => {
    ...
    // const CreateCard = () => (
    //        <div class="w-[500px] flex flex-col items-start border border-gray-200 p-5 rounded-lg bg-white">
    ...
    //             </svg>
    //         </div>
    //         <p class="text-sm mt-3 text-gray-500">I've been using imagify for nearly two years, primarily for Instagram, and it has been incredibly user-friendly, making my work much easier.</p>
    //         <div class="flex items-center gap-3 mt-4">
    //             <img  class="h-12 w12 rounded-full" src="https://images.unsplash.com/photo-1633332755192-727a05c4013d?q=80&w=100" alt="userImage1"/>
    //             <div>
    //                 <h2 class="text-lg text-gray-900 font-medium">Donald Jackman</h2>
    //                 <p class="text-sm text-gray-500">SWE 1 @ Amazon</p>
    //             </div>
    //         </div>
    //     </div>
    // )
